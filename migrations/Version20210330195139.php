 ...
 */
final class Version20210330195139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE serveur (id INT AUTO_INCREMENT NOT NULL, jeux_id INT DEFAULT NULL, adr_sv VARCHAR(255) NOT NULL, description_sv LONGTEXT DEFAULT NULL, nom_sv VARCHAR(255) NOT NULL, INDEX IDX_77CC53A6EC2AA9D2 (jeux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE serveur ADD CONSTRAINT FK_77CC53A6EC2AA9D2 FOREIGN KEY (jeux_id) REFERENCES jeux (id)');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE serveur DROP FOREIGN KEY FK_77CC53A6EC2AA9D2');
